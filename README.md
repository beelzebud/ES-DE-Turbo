...
A performance fork of [ES-DE](https://es-de.org) (EmulationStation Desktop Edition) that loads large collections significantly faster than the official build.

ES-DE is a frontend for browsing and launching games from your multi-platform collection. This fork keeps full upstream compatibility and behavior while optimizing the collection loading path: faster directory scanning, O(1) extension matching and cached sort keys. See [FASTLOADING.md](FASTLOADING.md) for what changed and how it works.

> This is an unofficial fork of ES-DE, licensed under the same [MIT license](LICENSE).
> Upstream credits: [CREDITS.md](CREDITS.md). Official site: <https://es-de.org>.
